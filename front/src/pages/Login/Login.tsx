          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-4">
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                <li>
                  <FiUser className="inline mr-1 h-4 w-4" /> Admin:
                  felipe@example.com / 123456
                </li>
                <li>
                  <FiUsers className="inline mr-1 h-4 w-4" /> Instrutor:
                  instructor1@email.com / 123456
                </li>
                <li>
                  <FiUser className="inline mr-1 h-4 w-4" /> Estudante:
                  student1@email.com / 123456
                </li>
              </ul>
            </div>
          </form>
